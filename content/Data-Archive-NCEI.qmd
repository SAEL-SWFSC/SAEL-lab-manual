...
<iframe src="https://www.ncei.noaa.gov/maps/passive-acoustic-data/" style="width:100%; height:750px; border: 2px solid black;">
...
NCEI has packaging tools to help automate this process. ADRIFT, CCES, and PASCAL data were archived using Passive Packer. NCEI has since released the Passive Acoustic Collection Engine (PACE) that allows for bulk processing and custom translators. PACE has replaced Passive Packer as our packaging tool.
