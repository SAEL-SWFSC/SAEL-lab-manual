...
#### [swfsc-1](https://console.cloud.google.com/storage/browser/swfsc-1;tab=objects?forceOnBucketsSortingFiltering=true&hl=en&invt=Abt4Vg&project=ggn-nmfs-pamdata-prod-1&prefix=&forceOnObjectsSortingFiltering=false) : all raw audio data and LTSAs

#### [swfsc-1-working](https://console.cloud.google.com/storage/browser/swfsc-1-working;tab=objects?hl=en&invt=Abt4Vg&project=ggn-nmfs-pamdata-prod-1&prefix=&forceOnObjectsSortingFiltering=false) : all metadata, analysis files, and other ancillary data

## Data Structure

Below is a general data structure of the two buckets. The most updated data structure can be accessed [here](https://docs.google.com/document/d/15gwvtf855YYQetF_ED7OJYPNQK2GFGw0sSl9HVp2tR4/edit?usp=sharing)

![](images/gcp_data_structure.jpg){fig-align="center"}
...
2.  Enter the follow command to upload files to the GCP: `gcloud storage cp -r [source pathway to files to be uploaded/] gs:[destination pathway to folder on bucket/]`
    -   SAEL ADRIFT Example `"gcloud storage cp -r E:\DATA\LEG_2\RECORDINGS\CalCurCEAS_004 gs://swfsc-1/drifting_recorder/CalCurCEAS_2024"`
...
### Automated sdk/gsutil Upload - OUTDATED
